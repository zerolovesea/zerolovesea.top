    ...
    >
      <div class="flex gap-4">
        <div class="flex flex-col items-center self-start md:flex-row md:gap-2">
          <span class="self-start text-lg font-medium md:self-auto">{{ idea.author }}</span>
          <span class="text-xs opacity-80 md:-translate-y-1 md:self-end">
